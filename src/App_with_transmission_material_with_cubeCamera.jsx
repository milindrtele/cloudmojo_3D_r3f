...
import { SoftShadows, useGLTF, OrbitControls, Stats, MeshReflectorMaterial, Environment, MeshTransmissionMaterial, CubeCamera } from "@react-three/drei";
...
function Model(props) {
    ...
    console.log(props.envMapTexture);
    ...
    const renderChildren = (parent, glassColor) => {
        return parent.children.map((child, index) => (
            ...
            >
                <MeshTransmissionMaterial envMap={props.envMapTexture} roughness={0} resolution={256} distortion={0} color={glassColor} thickness={1} anisotropy={0} />
            </mesh>
...
const App = () => {
    ...
    return (
        <Canvas shadows className="canvas">
            ...
            />
            <CubeCamera resolution={256} frames={1 /* Render once */}>
                {(texture) => (
                    <Model envMapTexture = {texture}/>
                )}
            </CubeCamera>
            {/* <ModelWithMaterials /> */}
